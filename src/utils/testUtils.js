...
if (typeof chrome !== 'undefined' && chrome.runtime) {
  ...
  window.NexusTestUtils = {
    ...
    async testDebuggerStability(iterations = 10) {
      ...
      return { successCount, errorCount, successRate: successCount / iterations };
    },
    ...
    async testMemoryUsage() {
      ...
      try {
        ...
        console.log("After debugger attach:", (afterAttach / 1024 / 1024).toFixed(2), "MB");
        
        await chrome.debugger.detach({ tabId: tab.id });
        
        const afterDetach = performance.memory.usedJSHeapSize;
        console.log("After debugger detach:", (afterDetach / 1024 / 1024).toFixed(2), "MB");
  ...
  console.log("NexusTestUtils loaded. Run window.NexusTestUtils.runAllTests() to test the extension.");
}
