      ...
      switch (impact?.toLowerCase()) {
        case "critical":
          return {
            ...
            path: `<path d="M4.343 0.0859375L0.0859375 4.343V11.657L4.343 15.914H11.657L15.914 11.657V4.343L11.657 0.0859375H4.343ZM4.929 1.429H11.071L14.571 4.929V11.071L11.071 14.571H4.929L1.429 11.071V4.929L4.929 1.429Z" fill="currentColor"/>
            <path d="M5.5 3.5L3.5 5.5V10.5L5.5 12.5H10.5L12.5 10.5V5.5L10.5 3.5H5.5Z" fill="currentColor"/>`,
          };
