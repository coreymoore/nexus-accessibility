/*
 * ARIA Query - Browser Bundle
 *
 * This file contains the aria-query library bundled for browser use.
 * Original library: https://github.com/A11yance/aria-query
 * License: Apache 2.0 License - Copyright 2020 A11yance
 *
 * Generated by Rollup from npm package aria-query
 * Do not edit this file directly - regenerate using: npm run build
 */
...
var AriaQuery = (function (exports) {
  ...
  function requireAriaPropsMap() {
    ...
    ariaPropsMap.default = (0, _iterationDecorator.default)(
      ariaPropsMap$1,
      ariaPropsMap$1.entries()
    );
    return ariaPropsMap;
  }
  ...
  function requireDomMap() {
    ...
    domMap.default = (0, _iterationDecorator.default)(
      domMap$1,
      domMap$1.entries()
    );
    return domMap;
  ...
  function requireAriaDpubRoles() {
    ...
    var _docBiblioentryRole = _interopRequireDefault(
      requireDocBiblioentryRole()
    );
    var _docBibliographyRole = _interopRequireDefault(
      requireDocBibliographyRole()
    );
  ...
  function requireRolesMap() {
    ...
    rolesMap.default = (0, _iterationDecorator.default)(
      rolesMap$1,
      rolesMap$1.entries()
    );
    return rolesMap;
  ...
  function requireElementRoleMap() {
      ...
      if (role) {
        ...
        var _loop = function _loop() {
          ...
          if (relation.module === "HTML") {
            ...
            if (concept) {
              var elementRoleRelation = elementRoles.filter(function (
                relation
              ) {
    ...
    function ariaRoleRelationConceptAttributeEquals(a, b) {
      ...
      if (a !== undefined && b !== undefined) {
        ...
        for (var _i4 = 0; _i4 < a.length; _i4++) {
          ...
          if (
            a[_i4].constraints === undefined &&
            b[_i4].constraints !== undefined
          ) {
            return false;
          }
          if (
    ...
    elementRoleMap.default = (0, _iterationDecorator.default)(
      elementRoleMap$1,
      elementRoleMap$1.entries()
    );
  ...
  function requireRoleElementMap() {
    ...
    roleElementMap.default = (0, _iterationDecorator.default)(
      roleElementMap$1,
      roleElementMap$1.entries()
    );
