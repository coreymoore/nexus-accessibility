/*
 * DOM Accessibility API - Browser Bundle
 *
 * This file contains the dom-accessibility-api library bundled for browser use.
 * Original library: https://github.com/eps1lon/dom-accessibility-api
 * License: MIT License - Copyright (c) 2020 Sebastian Silbermann
 *
 * Generated by Rollup from npm package dom-accessibility-api
...
var DOMAccessibilityAPI = (function (exports) {
  ...
  function _defineProperties(target, props) {
    for (var i = 0; i < props.length; i++) {
      ...
      Object.defineProperty(
        target,
        _toPropertyKey$1(descriptor.key),
        descriptor
      );
    }
  }
  ...
  function getLabels(element) {
    ...
    return arrayFrom(document.querySelectorAll("label")).filter(function (
      label
    ) {
  ...
  function computeTextAlternative(root) {
    ...
    function computeMiscTextAlternative(node, context) {
      ...
      var childNodes = isHTMLSlotElement(node)
    ...
    function computeElementTextAlternative(node) {
      ...
      if (isHTMLFieldSetElement(node)) {
        ...
        getLocalName(node) === "img" ||
        getLocalName(node) === "area"
      ) {
